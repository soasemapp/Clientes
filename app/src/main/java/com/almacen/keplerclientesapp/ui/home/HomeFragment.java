...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnMarca = view.findViewById(R.id.btnFMarca);
        btnModelo = view.findViewById(R.id.btnFModelo);
        btfLinea = view .findViewById(R.id.btfLinea);
        yearInicial = view.findViewById(R.id.yearInicio);
        yearFinal = view.findViewById(R.id.yearfinal);
        yearCheck = view.findViewById(R.id.checkyear);
        RecyclerProductos = view.findViewById(R.id.listProductos);
        btnBuscar = view.findViewById(R.id.btnBuscar);

        linearFiltro = view.findViewById(R.id.Filter);
        btnfiltro = view.findViewById(R.id.btnFilters);
...
linearFiltro.setVisibility(View.GONE);
        ...
        RecyclerProductos.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (check.equals("1") && (!marca.equals("") && !modelo.equals(""))) {
                    ...
                    listProdu2.clear();
                    listModelo.clear();
                    HomeFragment.ListProductos task = new HomeFragment.ListProductos();
                    task.execute();
        ...
        HomeFragment.ListMarca task = new HomeFragment.ListMarca();
        task.execute();
...
// create and show the alert dialog
        ...
        btnModelo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                HomeFragment.ListModelo task = new HomeFragment.ListModelo();
                task.execute();
            }
        });
...
// create and show the alert dialog
    ...
    private class ListMarca extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            mDialog.dismiss();
            HomeFragment.ListLineas task = new HomeFragment.ListLineas();
            task.execute();
...
// create and show the alert dialog
    ...
    private class ListProductos extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            HomeFragment.ListProductosPrecios task = new HomeFragment.ListProductosPrecios();
            task.execute();
