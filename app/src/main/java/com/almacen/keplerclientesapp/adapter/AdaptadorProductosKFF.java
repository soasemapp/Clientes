...
public class AdaptadorProductosKFF extends RecyclerView.Adapter<AdaptadorProductosKFF.ViewHolderProductosNuevos> implements View.OnClickListener {
    ...
    public AdaptadorProductosKFF(ArrayList<ProductosNuevosSANDG> listaConsulCoti, Context context, String empresa) {
