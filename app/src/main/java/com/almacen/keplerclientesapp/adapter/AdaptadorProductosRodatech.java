...
public class AdaptadorProductosRodatech extends RecyclerView.Adapter<AdaptadorProductosRodatech.ViewHolderProductosNuevos> implements View.OnClickListener {

    ArrayList<ProductosNuevosSANDG> listaproductos;
    Context context;
    private View.OnClickListener listener;

    public AdaptadorProductosRodatech(ArrayList<ProductosNuevosSANDG> listaConsulCoti, Context context) {
    ...
    public ViewHolderProductosNuevos onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_productosnuevosrodatech, null, false);
