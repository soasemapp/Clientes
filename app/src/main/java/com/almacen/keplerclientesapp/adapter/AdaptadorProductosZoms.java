...
public class AdaptadorProductosZoms extends RecyclerView.Adapter<AdaptadorProductosZoms.ViewHolderProductosNuevos> implements View.OnClickListener {
    ...
    public AdaptadorProductosZoms(ArrayList<ProductosNuevosSANDG> listaConsulCoti, Context context, String empresa) {
