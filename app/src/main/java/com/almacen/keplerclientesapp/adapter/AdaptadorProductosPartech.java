...
public class AdaptadorProductosPartech extends RecyclerView.Adapter<AdaptadorProductosPartech.ViewHolderProductosNuevos> implements View.OnClickListener {
    ...
    public AdaptadorProductosPartech(ArrayList<ProductosNuevosSANDG> listaConsulCoti, Context context) {
    ...
    public ViewHolderProductosNuevos onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_productosnuevospartech, null, false);
